...
The next lab will configure **Inter-VLAN Routing using Router-on-a-Stick**, allowing devices from different VLANs to communicate with each other.

---

### 👨‍💻 CCNA Practical Lab

**Lab:** 4 — Trunk Configuration
